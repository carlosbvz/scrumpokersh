...
class ScrumPocker extends React.Component {
    ...
    getPlayersFromDB() {
        axios.get('http://localhost:3001/api/get/players')
            .then(playersData => {
    ...
    onUsernameChange(userName) {
        ...
        axios.post('http://localhost:3001/api/update/player', {
    ...
    onDeletePlayer(playerId) {
        axios.post('http://localhost:3001/api/delete/player', {
            id: playerId
        });
    }
    getCards() {
    ...
    clearEstimates() {
        ...
        if (this.state.isClearingEstimates) {
            axios.post('http://localhost:3001/api/delete/estimates', {
                id: []
            });
